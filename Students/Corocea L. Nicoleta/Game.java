...
public class Game {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < Constants.NUMBER_OF_ROUNDS; i++) {
			...
			Thread.sleep(1000);
			// Display the resources from the map
			map.showResources();
			...
			// Read an integer from the keyboard and update
			// the minerNextAction variable accordingly

			int value = scanner.nextInt();
			minerNextAction = value;
			int resource = 0;
			...
			case 0:
				...
				Thread.sleep(2000);
				// Make the miner sleep and update the resource variable
				// with the
		...
		System.out.println("[Game] ####################################");
		System.out.println("[Game] GAME OVER! Your miner found " + valuableResources + "/"
				+ Constants.MAP_RESOURCES_NUMBER + " valuable resources");
