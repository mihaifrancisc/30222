...
public class Game {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < Constants.NUMBER_OF_ROUNDS; i++) {
			...
			// TODO: Read an integer from the keyboard and update the
			// minerNextAction variable accordingly
			...
			case 0:
				...
				// with the value returned by the sleep method
